...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      githubUrl: "#",
      bgColor:
        "bg-gradient-to-br from-blue-200 via-blue-300 to-cyan-200 dark:from-blue-300 dark:via-blue-400 dark:to-cyan-300",
    },
    {
      id: 6,
      ...
      githubUrl: "#",
      bgColor:
        "bg-gradient-to-br from-pink-200 via-rose-300 to-red-200 dark:from-pink-300 dark:via-rose-400 dark:to-red-300",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
                ...
                >
                  ...
                  >
                    <div
                      className={`${
                        project.bgColor
                      } rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-4 sm:mb-6 aspect-[4/3] flex items-center justify-center overflow-hidden transition-all duration-500 relative shadow-xl shadow-black/10 dark:shadow-black/30 hover:shadow-2xl hover:shadow-black/20 dark:hover:shadow-black/50 hover:-translate-y-2 ${
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="font-clash text-lg sm:text-xl md:text-2xl font-bold mb-1 sm:mb-2 text-black dark:text-white group-hover:text-green-500 transition-colors duration-300">
                          {project.title}
                        </h3>
        ...
        <ScrollReveal direction="up" delay={0.8}>
          <div className="text-center mt-12 sm:mt-16 bg-white dark:bg-[#111116] rounded-2xl p-8 sm:p-12 shadow-2xl shadow-black/10 dark:shadow-black/30 hover:shadow-3xl hover:shadow-black/15 dark:hover:shadow-black/40 transition-all duration-500 hover:-translate-y-1">
            ...
            <h2 className="font-clash text-2xl sm:text-3xl font-bold text-black dark:text-white mb-3 sm:mb-4">
