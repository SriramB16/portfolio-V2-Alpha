  ...
  useEffect(() => {
    ...
    if (location.pathname === "/") {
      ...
      const hasSeenIntroThisSession =
        sessionStorage.getItem("hasSeenIntroThisSession") === "true";
      ...
      const shouldShowIntro =
        isPageReload || (!hasSeenIntroThisSession && !isInternalNavigation);
  ...
  const projects = [
    {
      ...
      githubUrl: "#",
      bgColor:
        "bg-gradient-to-br from-yellow-200 via-yellow-300 to-orange-200 dark:from-yellow-300 dark:via-yellow-400 dark:to-orange-300",
      year: "2024",
    },
    {
      id: 2,
      ...
      category: "Mobile",
      description:
        "A React Native app for team collaboration and project management.",
      image:
      ...
      githubUrl: "#",
      bgColor:
        "bg-gradient-to-br from-purple-200 via-purple-300 to-pink-200 dark:from-purple-300 dark:via-purple-400 dark:to-pink-300",
      year: "2024",
    },
    {
      id: 3,
      ...
      githubUrl: "#",
      bgColor:
        "bg-gradient-to-br from-gray-200 via-gray-300 to-slate-200 dark:from-gray-300 dark:via-gray-400 dark:to-slate-300",
      year: "2024",
    },
    {
      id: 4,
      ...
      githubUrl: "#",
      bgColor:
        "bg-gradient-to-br from-green-200 via-emerald-300 to-teal-200 dark:from-green-300 dark:via-emerald-400 dark:to-teal-300",
      year: "2024",
    },
  ];
        ...
        >
              ...
              <ScrollReveal direction="up" delay={0.2}>
                <div className="w-full lg:w-4/5 mb-8 sm:mb-12 lg:mb-16">
                  <h1 className="font-clash text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold leading-tight">
                    Crafting{" "}
                    <span className="text-green-500">purpose driven</span>
                    <br />
                    <span className="text-green-500">experiences</span> that
                    inspire
                    <br />& engage.
                  </h1>
                </div>
                ...
                <div className="flex flex-col lg:flex-row mb-8 sm:mb-12 w-full">
                  ...
                  <div className="flex-1 flex items-center order-1 lg:order-2 mb-6 lg:mb-0">
                    <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg lg:text-xl leading-relaxed font-satoshi">
                      I work with brands globally to build pixel-perfect,
                      engaging, and accessible digital experiences that drive
                  ...
                  <div className="order-2 lg:order-1 flex justify-center lg:justify-start">
                    ...
                    >
                      {[
                        ...
                        {
                          name: "GITHUB",
                          href: "https://github.com/SriramB16",
                        },
                        {
                          name: "INSTAGRAM",
                        ...
                        {
                          name: "GMAIL",
                          href: "mailto:srirambaskaran16@gmail.com",
                        },
                      ].map((social) => (
                        <a
                          key={social.name}
          ...
          <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-10 lg:px-16">
            <div className="max-w-6xl mx-auto">
              ...
              <ScrollReveal direction="up" delay={0.2}>
                <h2 className="font-clash text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-3 sm:mb-4">
                  Selected Projects
                </h2>
              </ScrollReveal>
                  ...
                  <ScrollReveal direction="up" delay={0.4}>
                    ...
                    >
                      <div
                        className={`${
                          projects[0].bgColor
                        } rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-4 sm:mb-6 aspect-[4/3] flex items-center justify-center overflow-hidden transition-all duration-500 shadow-xl shadow-black/10 dark:shadow-black/30 hover:shadow-2xl hover:shadow-black/20 dark:hover:shadow-black/50 hover:-translate-y-2 ${
                          hoveredProject && hoveredProject !== 1
                            ? "opacity-30 scale-95"
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-clash text-lg sm:text-xl md:text-2xl font-bold mb-1 sm:mb-2">
                            {projects[0].title}
                          </h3>
                          <p className="text-gray-600 dark:text-gray-400 mb-1 sm:mb-2 text-sm sm:text-base">
                            {projects[0].category}
                          </p>
                        </div>
                    ...
                    >
                      <div
                        className={`${
                          ...
                          hoveredProject && hoveredProject !== 3
                            ? "opacity-30 scale-95"
                            : "opacity-100 scale-100"
                        }`}
                      >
                    ...
                    >
                      <div
                        className={`${
                          ...
                          hoveredProject && hoveredProject !== 2
                            ? "opacity-30 scale-95"
                            : "opacity-100 scale-100"
                        }`}
                      >
                    ...
                    >
                      <div
                        className={`${
                          ...
                          hoveredProject && hoveredProject !== 4
                            ? "opacity-30 scale-95"
                            : "opacity-100 scale-100"
                        }`}
                      >
