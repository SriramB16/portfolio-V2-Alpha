      ...
      buildSteps: [
        {
          ...
          command:
            "git clone https://github.com/sriram/ecommerce-platform && cd ecommerce-platform",
        },
        {
      ...
      buildSteps: [
        {
          title: "Clone this repo",
          command:
            "git clone https://github.com/sriram/design-system && cd design-system",
        },
        {
          title: "Install project dependencies",
          command: "npm install",
            ...
            <ScrollReveal direction="right" delay={0.4}>
              <div className="space-y-1">
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                  <span className="font-clash text-base sm:text-lg font-semibold text-black dark:text-white">
                    Roles:
                  </span>
                  <span className="text-gray-600 dark:text-gray-400 text-sm sm:text-base font-light">
          ...
          <div className="mb-8 sm:mb-12 md:mb-16">
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              {currentProject.screenshots.map((screenshot, index) => (
                <div
                  key={index}
                  className="rounded-xl sm:rounded-2xl overflow-hidden shadow-xl shadow-black/10 dark:shadow-black/30 hover:shadow-2xl hover:shadow-black/20 dark:hover:shadow-black/50 transition-all duration-500 hover:-translate-y-1"
                >
                  <img
                    src={screenshot}
                  ...
                  <div className="text-sm sm:text-base font-light leading-relaxed min-w-0">
                    ...
                    <span className="text-gray-600 dark:text-gray-400">
                      ...
                      {techDescriptions[tech] ||
                        "Technology description not available."}
                    </span>
                  </div>
                </div>
              ))}
                    ...
                    <div className="relative bg-gray-100 dark:bg-gray-800 rounded-lg p-3 sm:p-4 md:p-6 font-mono text-xs sm:text-sm md:text-base overflow-hidden border border-gray-200 dark:border-gray-700">
                      ...
                      >
                        {copiedStep === index ? (
                          ...
                          <Copy
                            size={14}
                            className="sm:w-4 sm:h-4 text-gray-600 dark:text-gray-300 group-hover:text-gray-800 dark:group-hover:text-white"
                          />
                        )}
                      </button>
                    </div>
        ...
        <ScrollReveal direction="up" delay={1.1}>
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-4 mb-8 sm:mb-12 md:mb-16">
            ...
            >
              <ChevronLeft
                size={16}
                className="sm:w-[18px] sm:h-[18px] text-gray-700 dark:text-white group-hover:-translate-x-1 transition-transform duration-300 flex-shrink-0"
              />
