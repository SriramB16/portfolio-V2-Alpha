...
import brandingVid from "../assets/homepage/Branding-homempage.mp4";
import devVid from "../assets/homepage/Developement_homepage.mp4";
import uiuxVid from "../assets/homepage/UIUX-homepage.mp4";
...
const ExpertiseAccordion = () => {
  ...
  const expertiseAreas = [
    {
      ...
      icon: Code,
      description:
        "Full-stack web development with modern technologies like React, Node.js, and cloud platforms.",
      skills: [
        "React & Next.js",
        "Node.js & Express",
        "TypeScript",
    ...
    },
    {
      ...
      icon: Palette,
      description:
        "Creating intuitive and beautiful user interfaces that prioritize user experience.",
    ...
    },
    {
      ...
      icon: Megaphone,
      description:
        "Developing comprehensive brand identities that tell your story and connect with your audience.",
      skills: [
        "Logo Design",
        "Brand Strategy",
        "Visual Identity",
  ...
  const displayedAccordion =
    activeAccordion !== -1 ? activeAccordion : lastOpenedAccordion;
                ...
                <div className="bg-white dark:bg-[#111116] rounded-xl shadow-lg shadow-black/5 dark:shadow-black/20 hover:shadow-xl hover:shadow-black/10 dark:hover:shadow-black/30 transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-800">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-gradient-to-r ${area.color} flex items-center justify-center shadow-md`}
                      >
                        <area.icon
                          size={16}
          ...
          <ScrollReveal direction="right" delay={0.4}>
            <div className="sticky top-8">
              <div className="relative bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 rounded-xl sm:rounded-2xl overflow-hidden shadow-xl shadow-black/15 dark:shadow-black/30 aspect-[4/3]">
                ...
                <AnimatePresence mode="wait">
                  {expertiseAreas[displayedAccordion]?.mediaType === "image" ? (
                    <motion.img
                      key={`img-${displayedAccordion}`}
                      src={expertiseAreas[displayedAccordion]?.mediaUrl}
                      alt={expertiseAreas[displayedAccordion]?.title}
                      className="w-full h-full object-cover"
                      initial={{ opacity: 0, scale: 1.05 }}
                      animate={{ opacity: 1, scale: 1 }}
                ...
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4">
                  <div
                    className={`inline-flex items-center gap-2 px-3 py-2 bg-white/90 dark:bg-black/90 backdrop-blur-sm rounded-lg shadow-md`}
                  >
                    <div
                      className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${expertiseAreas[displayedAccordion]?.color}`}
                    ></div>
