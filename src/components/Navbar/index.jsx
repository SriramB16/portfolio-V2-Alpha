import { FolderGit2, Home, Mail, Moon, User } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <>
      {/* Mobile top logo */}
      <div
        className={`fixed top-0 left-0 w-full md:hidden z-50 transition-colors duration-300 ${
          isHomePage
            ? "bg-[#f7f8fa] dark:bg-black"
            : "bg-[#f7f8fa] dark:bg-black"
        }`}
      >
          ...
          <div className="flex-1 flex justify-center min-w-0">
            <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-6 xl:space-x-8">
              <NavLink
                to="/"
                label="Home"
                icon={<Home size={16} className="sm:w-[18px] sm:h-[18px]" />}
              ...
              <NavLink
                ...
                label="Projects"
                icon={
                  <FolderGit2 size={16} className="sm:w-[18px] sm:h-[18px]" />
                }
            ...
            >
              <div className="relative w-4 h-4 sm:w-5 sm:h-5">
                ...
                >
                  <Moon
                    size={16}
                    className="sm:w-[18px] sm:h-[18px] text-black group-hover:text-gray-800 transition-colors duration-200"
                  />
                </div>
        ...
        >
          <div className="flex items-center justify-around py-2 px-1">
            ...
            <NavLink
              to="/projects"
              label="Projects"
              icon={<FolderGit2 size={18} className="sm:w-5 sm:h-5" />}
              active={location.pathname === "/projects"}
              onClick={handleNavClick}
            />
            <NavLink
...
const NavLink = ({ to, label, icon, active = false, onClick }) => {
  return (
    ...
    >
      ...
      <span className="text-xs md:text-xs lg:text-sm font-medium whitespace-nowrap truncate max-w-full">
        {label}
      </span>
      {/* Active indicator */}
      {active && (
